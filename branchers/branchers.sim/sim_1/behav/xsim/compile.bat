...
REM
REM Generated by Vivado on Sat May 10 16:14:55 -0500 2025
...
echo "xvlog --incr --relax -prj tb_gshare_vlog.prj"
call xvlog  --incr --relax -prj tb_gshare_vlog.prj -log xvlog.log
