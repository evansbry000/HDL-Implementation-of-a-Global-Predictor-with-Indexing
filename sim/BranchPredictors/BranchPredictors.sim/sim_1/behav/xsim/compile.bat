...
REM
REM Generated by Vivado on Sat May 10 14:58:08 -0500 2025
...
echo "xvlog --incr --relax -prj tb_gpredict_vlog.prj"
call xvlog  --incr --relax -prj tb_gpredict_vlog.prj -log xvlog.log
